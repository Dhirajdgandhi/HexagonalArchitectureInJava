...
//        assertTrue(priorityQueue.getQueue().equals(sortedA));
    ...
    public void getOptimalCost(){
        ...
        assert(new RepeatedAStarSearch().getOptimalPathCostToReachGoal(gridWorld, Pair.of(2,0), Pair.of(4,0))==12);
        System.out.println();
        ...
        new RepeatedAStarSearch().getOptimalPathCostToReachGoal(gridWorld, Pair.of(4,0), Pair.of(2,0));
        System.out.println();
        ...
        assert(new RepeatedAStarSearch().getOptimalPathCostToReachGoal(gridWorld, Pair.of(2,0), Pair.of(4,0))==-1);
        System.out.println();
